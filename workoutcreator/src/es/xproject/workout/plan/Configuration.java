...
public class Configuration {
	...
	private static void createExtra() {
		...
		extraWorkouts.add(WorkoutFactory.getInstance().buildOverUnder("Castlevania",6,8*60,6*60,85,4,105,false));
		extraWorkouts.add(WorkoutFactory.getInstance().buildOverUnder("Shogun",6,8*60,5*60,84,4,110,true));
		
		
		extraWorkouts.add(WorkoutFactory.getInstance().buildWithSurge("Rocinante", 5, 3 * 60, 1* 60, 95, 150, 30, false, 15 * 60, 65));
		extraWorkouts.add(WorkoutFactory.getInstance().buildWithSurge("Kona", 6, 5 * 60, 2* 60, 88, 120, 60, false, 15 * 60, 65));
		...
		extraWorkouts.add(WorkoutFactory.getInstance().buildOverUnder("Ska",3,20*60,6*60,80,5,95,false));
		extraWorkouts.add(WorkoutFactory.getInstance().buildOverUnder("RaiseSweet",4,18*60,6*60,76,6,98,true));
		
		extraWorkouts.add(WorkoutFactory.getInstance().buildLowRecovery("Temporal",5,10*60,5*60,70,94,70));
		
		//buildLowRecovery String name, int intervals, int duration, int recovery, int power, int raisePower,int recoveryPower) {
		extraWorkouts.add(WorkoutFactory.getInstance().buildLowRecovery("BradburyRamps",5,5*60,5*60,90,90,55));
		
		//buildStromlo(String name, int intervals, int duration, int recovery, int power, int raisePower,int recoveryDuration, int recoveryPower) {
		extraWorkouts.add(WorkoutFactory.getInstance().buildStromlo("Bradbury",2,15*60,5*60,75,85,20*60,75));
	...
	/*	.add(0);
		...
		ArrayList<Workout> Rec = new ArrayList<Workout>();
		.add(0);
		.add(90);
		.add(60);
		.add(120);
