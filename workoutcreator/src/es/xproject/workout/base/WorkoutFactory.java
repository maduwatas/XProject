...
public class WorkoutFactory {
	...
	public Workout buildBernhardt(String name, int interval_1, int interval_2, int interval_3, int duration_1, int duration_2, int duration_3) {
	...
	public Workout buildStages(String name, int series, int repeats, int timeUp, int timeDown, int recovery, int powerUp, int powerDown) {
